...
class Graph:
    ...
    def getHamiltonian(self):
        ...
        """
        self.clearVisited()
        if self.isConnected() == True and self.totalV > 2:
    ...
    def tryVisiting(self, vertex, totalvisited, Hamiltonian):
        ...
        """
        if totalvisited == self.totalV and not Hamiltonian.isTrivial():
            ...
            for i in range(1, self.totalV):
                if i not in Hamiltonian.getVertices() and self.edges[vertex][i] != 0:
